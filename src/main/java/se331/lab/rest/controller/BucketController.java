...
public class BucketController {
    ...
    public ResponseEntity<?> uploadFile(@RequestPart(value = "file")
        ...
        return
                ResponseEntity.ok(this.cloudStorageHelper.getImageUrl(file,"imageupload-d6d95.appspot.com"));
    }
    @PostMapping("/uploadImage")
    public ResponseEntity<?> uploadFileComponent(@RequestPart(value = "image" )
                                                 MultipartFile file) throws IOException, ServletException{
        return
                ResponseEntity.ok((this.cloudStorageHelper.getStorageFileDto(file,"imageupload-d6d95.appspot.com")));
    }
}
